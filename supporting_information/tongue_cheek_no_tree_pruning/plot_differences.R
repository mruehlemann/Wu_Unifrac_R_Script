...
min.sample.depth <- 659
d.tongue.cheek.data <- rrarefy(original.tongue.cheek.data, min.sample.depth)
e.tongue.cheek.data <- rrarefy(original.tongue.cheek.data, min.sample.depth)
...
d.tongue.cheek.unifrac <- getDistanceMatrix(d.tongue.cheek.data,d.tongue.cheek.tree,method="unweighted",verbose=TRUE,pruneTree=FALSE)
e.tongue.cheek.unifrac <- getDistanceMatrix(e.tongue.cheek.data,e.tongue.cheek.tree,method="unweighted",verbose=TRUE,pruneTree=FALSE)
